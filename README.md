# EC-GAN
This repository contains the implementation of the paper "EC-GAN: Low-Sample Classification using Semi-Supervised Algorithms and GANs" by Ayaan Haque, which will appear at [AAAI 2021](https://aaai.org/Conferences/AAAI-21/) conference and will be published in the proceedings.
